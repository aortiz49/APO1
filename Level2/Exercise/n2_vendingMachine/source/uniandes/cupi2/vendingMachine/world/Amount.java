...
public class Amount {
	...
	public final static double MAX_VALUE = 10000;
	
	// Constant that represents a $50 COP coin.
	public final static int COIN_50 = 50;
	
	// Constant that represents a $100 COP coin.
	public final static int COIN_100 = 100;
	
	// Constant that represents a $200 COP coin.
	public final static int COIN_200 = 200;
	
	// Constant that represents a $500 COP coin.
	public final static int COIN_500 = 500;
	
	// Constant that represents a $1000 COP coin.
	public final static int COIN_1000 = 1000;
	...
	public double getTotalValue() {
		return quantityOfCoins50 * COIN_50 + quantityOfCoins100 * COIN_100 +
			quantityOfCoins200 * COIN_200 + quantityOfCoins500 * COIN_500 +
			quantityOfCoins1000 * COIN_1000;
	}
	...
	/*
	 * Assigns the quantity of coins of each denominations necessary to complete the value
	...
	public void changeValue(double pValue) {
		quantityOfCoins1000 = (int)(pValue / 1000);
		int remainder = (int)(pValue % 1000);
		
		quantityOfCoins500 = remainder / 500;
		remainder %= 500;
		
		quantityOfCoins200 = remainder / 200;
		remainder %= 200;
		
		quantityOfCoins100 = remainder / 100;
		remainder %= 100;
		
		quantityOfCoins50 = remainder / 50;
