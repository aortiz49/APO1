...
public class CampeonatoTest
{
    ...
    public void testRegistrarResultado1( )
    {
        ...
        assertEquals( "El número de partidos empatados del primer equipo estú equivocado", "0", datos1[ 4 ] );
        assertEquals( "El número de partidos perdidos del primer equipo estú equivocado", "0", datos1[ 5 ] );
        assertEquals( "El número de goles a favor del primer equipo estú equivocado", "9", datos1[ 6 ] );
        assertEquals( "El número de goles en contra del primer equipo estú equivocado", "1", datos1[ 7 ] );
