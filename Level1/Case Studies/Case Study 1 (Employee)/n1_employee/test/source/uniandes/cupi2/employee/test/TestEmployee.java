package uniandes.cupi2.employee.test;
...
public class TestEmployee{
	public static void main(String[] args) {
		...
		employee2.changeEmployee("Alex", "Rodriguez",0,birthday2,entryDate2,9500000,"employee2.jpg");
		employee3.changeEmployee("Kylie", "Jenner",1,birthday3,entryDate3,35000000,"employee1.png");
