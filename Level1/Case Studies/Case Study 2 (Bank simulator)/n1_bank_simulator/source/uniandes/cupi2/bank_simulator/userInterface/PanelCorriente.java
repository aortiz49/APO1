...
public class PanelCorriente extends JPanel implements ActionListener
{
     ...
     */
    private JButton btnConsignarCheckingAccount;

    /**
     * Boton para hacer retiros de la cuenta corriente.
     */
    private JButton btnRetirarCheckingAccount;
    ...
    public PanelCorriente( InterfazSimulador pPrincipal )
    {
        ...
        btnConsignarCheckingAccount = new JButton( "Consignar" );
        btnConsignarCheckingAccount.setActionCommand( CONSIGNAR_CUENTA_CORRIENTE );
        btnConsignarCheckingAccount.addActionListener( this );
        btnConsignarCheckingAccount.setPreferredSize( new Dimension( 100, 0 ) );

        btnRetirarCheckingAccount = new JButton( "Retirar" );
        btnRetirarCheckingAccount.setActionCommand( RETIRAR_CUENTA_CORRIENTE );
        btnRetirarCheckingAccount.addActionListener( this );
        btnRetirarCheckingAccount.setPreferredSize( new Dimension( 100, 0 ) );
        ...
        panelBotones.add( btnConsignarCheckingAccount, BorderLayout.WEST );
        panelBotones.add( new JLabel( " " ), BorderLayout.CENTER );
        panelBotones.add( btnRetirarCheckingAccount, BorderLayout.EAST );
    ...
    /**
     * Actualiza el saldo de la cuenta corriente del cliente en la userInterface. <br>
     * <b>post: </b> Se actualiz� la informaci�n con el saldo de la cuenta de corriente.
