...
public class PanelCard extends JPanel implements ActionListener {
	 ...
	 * <b>post:</b> Todos los botones fueron inicializados. Se asignaron los atributos principal,
     * player, country y year con los parametros dados.
	 * @param pUserInterface UserInterface principal of the  aplicacion. pUserInterface != null
	 * @param pCountry Country al cual represento el player of the  lamina. pCountry != null &&
     *                    pCountry != "".
	 ...
	 * <b>post:</b>La informacion mostrada se actualizo. Se modifyon los atributos country, year y
     * player con los parametros dados..<br>
	 * @param pCountry Country al cual represento el player of the  lamina. pCountry != null &&
     *                    pCountry != "".
	 * @param pYear Year en el cual el player of the  lamina represento al pais. pYear > 0.
	...
	public void actualizar(String pCountry, int pYear, Player pPlayer) {
		...
		if(player.getCard() != null) {
			btnCard.setText("");
			File archImagen = new File("./data/images/" + pCountry + "/" + pYear + "/" + player
                    .getCard().getImageName());
			ImageIcon icono = archImagen.exists() ? new ImageIcon(archImagen.getAbsolutePath()) :
                    LAMINA_DEFECTO;
	...
	public void actionPerformed(ActionEvent pEvent) {
		...
		switch(command) {
			...
			case MODIFICAR:
				DialogModifyPlayer dialogoModify = new DialogModifyPlayer(principal, country,
                                                                          year, player);
