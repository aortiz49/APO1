...
public class albumInterface extends JFrame {
	...
	/**
	 * Pega la lamina del player del team con el n�mero de shirt dado.<br>
	 * <b>pre: </b> El player existe.<br>
	 * <b>post: </b>Se pego la lamina del player.
	 *
	 * @param pCountry     Country del team. pCountry != null && pCountry != "".
	 * @param pYear        Year en el cual el team represento al pais. pYear > 0.
	 * @param pShirtNumber N�mero of the  shirt del player. pShirtNumber > 0.
	 */
	 ...
	 * @param pYear             Year en el cual el team represento al pais. pYear > 0.
	 * @param pShirtNumber      N�mero of the  shirt del player. pShirtNumber > 0.
	 * @param pShirtNumberNueva N�mero nuevo of the  shirt del player. pShirtNumberNueva > 0.
	...
	/**
	 * Agrega al album un team que represento a un pais en un a�o dado.<br>
	...
	/**
	 * Muestra el dialogo para ingresar un a�o y muestra los teams de ese a�o.
	 */
	public void findTeamsPorYear() {
		
		String input = JOptionPane.showInputDialog(this, "Enter year to search", "Find " +
				"teams" + " by a�o", JOptionPane.QUESTION_MESSAGE);
		try {
	 ...
	 * player.
	 *
	 * @param pShirt   N�mero of the  shirt del player. pShirt > 0.
	 * @param pCountry Country del team. pCountry != null && pCountry != "".
	 * @param pYear    Year en el cual el team represento al pais. pYear > 0.
	 */
	...
	/**
	 * Muestra el dialogo para conocer la edad mas com�n de un team del alb�m.
	 */
